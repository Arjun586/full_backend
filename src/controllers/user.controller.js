...
const updateCoverImage = asyncHandler( async(req, res) => {
    const coverImageLocalPath = req.file?.path
        ...
        //TODO: Delete coverImage from cloudinary

    if(!avatarLocalPath){
        throw new ApiError(400, "coverImage not present")
    }
